...
namespace W_DICTIONARY
{
    public partial class frmLikeWord : Form
    {
        ...
        private void btn_DeleteLikeWord_Click(object sender, EventArgs e) //delete
        {
            ...
            cmd.Parameters.AddWithValue("English", txtEnglish_Like.Text);  //statement add
            cmd.Parameters.AddWithValue("VNShort", txtVNShort_Like.Text);
            cmd.Parameters.AddWithValue("VNLong", txtVNLong_Like.Text);
            cmd.ExecuteNonQuery();
            Loaddata();
        }
    }
